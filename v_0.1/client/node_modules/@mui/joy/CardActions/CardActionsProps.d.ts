...
export type CardActionsSlotsAndSlotProps = CreateSlotsAndSlotProps<CardActionsSlots, {
...
export type CardActionsProps<D extends React.ElementType = CardActionsTypeMap['defaultComponent'], P = {
