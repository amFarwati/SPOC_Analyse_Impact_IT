...
export const SheetRoot = styled('div', {
  ...
  return [_extends({
    ...
    position: 'relative'
  }), _extends({}, theme.typography['body-md'], variantStyle), ownerState.color !== 'context' && ownerState.invertedColors && theme.colorInversion[ownerState.variant]?.[ownerState.color]];
});
/**
 *
 * Demos:
