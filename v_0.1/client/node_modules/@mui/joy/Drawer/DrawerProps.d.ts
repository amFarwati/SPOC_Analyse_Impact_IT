...
export interface DrawerTypeMap<P = {}, D extends React.ElementType = 'div'> {
    props: P & Omit<ModalOwnProps, 'keepMounted' | 'children'> & DrawerSlotsAndSlotProps & {
        /**
...
export type DrawerProps<D extends React.ElementType = DrawerTypeMap['defaultComponent'], P = {
