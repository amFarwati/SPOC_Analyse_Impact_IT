...
import { ColorPaletteProp, VariantProp, SxProps, ApplyColorInversion } from '@mui/joy/styles/types';
...
export type ButtonGroupSlotsAndSlotProps = CreateSlotsAndSlotProps<ButtonGroupSlots, {
...
export type ButtonGroupProps<D extends React.ElementType = ButtonGroupTypeMap['defaultComponent'], P = {
