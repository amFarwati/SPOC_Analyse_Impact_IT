...
export type AccordionGroupSlotsAndSlotProps = CreateSlotsAndSlotProps<AccordionGroupSlots, {
...
export type AccordionGroupProps<D extends React.ElementType = AccordionGroupTypeMap['defaultComponent'], P = {
