...
import { ColorPaletteProp, SxProps, TypographySystem, VariantProp, ApplyColorInversion } from '@mui/joy/styles/types';
...
export type DialogTitleSlotsAndSlotProps = CreateSlotsAndSlotProps<DialogTitleSlots, {
...
export type DialogTitleProps<D extends React.ElementType = DialogTitleTypeMap['defaultComponent'], P = {
