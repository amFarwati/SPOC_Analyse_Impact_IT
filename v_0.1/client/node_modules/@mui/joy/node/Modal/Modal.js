...
const StyledModalRoot = (0, _styles.styled)('div')(({
  ownerState,
  theme
}) => (0, _extends2.default)({
...
exports.StyledModalRoot = StyledModalRoot;
const ModalRoot = (0, _styles.styled)(StyledModalRoot, {
  name: 'JoyModal',
  slot: 'Root',
  overridesResolver: (props, styles) => styles.root
})({});
const StyledModalBackdrop = (0, _styles.styled)('div')(({
  theme
}) => ({
  zIndex: -1,
  position: 'fixed',
...
const ModalBackdrop = (0, _styles.styled)(StyledModalBackdrop, {
  name: 'JoyModal',
  slot: 'Backdrop',
