...
import { CreateSlotsAndSlotProps, SlotProps } from '@mui/joy/utils/types';
...
export type ModalOwnProps = Pick<BaseModalOwnProps, 'children' | 'container' | 'disableAutoFocus' | 'disableEnforceFocus' | 'disableEscapeKeyDown' | 'disablePortal' | 'disableRestoreFocus' | 'disableScrollLock' | 'hideBackdrop' | 'keepMounted' | 'open'> & {
    /**
