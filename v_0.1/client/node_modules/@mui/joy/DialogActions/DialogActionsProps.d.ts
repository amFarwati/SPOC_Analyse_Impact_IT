...
export type DialogActionsSlotsAndSlotProps = CreateSlotsAndSlotProps<DialogActionsSlots, {
...
export type DialogActionsProps<D extends React.ElementType = DialogActionsTypeMap['defaultComponent'], P = {
