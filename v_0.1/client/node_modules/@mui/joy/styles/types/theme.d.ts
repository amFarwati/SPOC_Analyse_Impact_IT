...
import { DefaultColorScheme, ExtendedColorScheme } from '@mui/joy/styles/types/colorScheme';
import { ColorSystem } from '@mui/joy/styles/types/colorSystem';
import { Focus } from '@mui/joy/styles/types/focus';
import { DefaultShadow, Shadow } from '@mui/joy/styles/types/shadow';
import { DefaultRadius, Radius } from '@mui/joy/styles/types/radius';
import { FontFamily, FontSize, FontWeight, LineHeight, TypographySystem, DefaultFontFamily, DefaultFontSize, DefaultFontWeight, DefaultLineHeight } from '@mui/joy/styles/types/typography';
import { Variants, ColorInversion, ColorInversionConfig } from '@mui/joy/styles/types/variants';
import { DefaultZIndex, ZIndex } from '@mui/joy/styles/types/zIndex';
import { MergeDefault } from '@mui/joy/styles/types/utils';
