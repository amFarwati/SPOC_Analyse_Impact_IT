...
export type DialogContentSlotsAndSlotProps = CreateSlotsAndSlotProps<DialogContentSlots, {
...
export type DialogContentProps<D extends React.ElementType = DialogContentTypeMap['defaultComponent'], P = {
