...
import { ColorPaletteProp, SxProps, VariantProp, ApplyColorInversion } from '@mui/joy/styles/types';
import { SlotProps, CreateSlotsAndSlotProps } from '@mui/joy/utils/types';
...
export type MenuButtonSlotsAndSlotProps = CreateSlotsAndSlotProps<MenuButtonSlots, {
...
export interface MenuButtonTypeMap<P = {}, D extends React.ElementType = 'button'> {
    props: P & MenuButtonSlotsAndSlotProps & {
        /**
...
export type MenuButtonProps<D extends React.ElementType = MenuButtonTypeMap['defaultComponent'], P = {
